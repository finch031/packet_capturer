...
public class QueryRunner extends AbstractQueryRunner {
     ...
     * {@link #execute(Connection, String, com.github.db.ResultSetHandler, Object...) }.
     *
     * @param conn The connection to use to run the query.
     * @param sql The SQL to execute.
     * @param params The query replacement parameters.
     ...
     * If the stored procedure returns result sets, use
     * {@link #execute(String, com.github.db.ResultSetHandler, Object...) }.
     * <p>
     ...
     * {@link #query(Connection, String, com.github.db.ResultSetHandler, Object...) }
     ...
     * result sets; b) invoking a stored procedure that return result
     * sets and OUT parameters.  Otherwise you may wish to use
     * {@link #query(String, com.github.db.ResultSetHandler, Object...) }
     * (if there are no OUT parameters) or
