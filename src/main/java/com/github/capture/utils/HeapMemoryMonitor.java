...
/**
 * Class that monitors memory usage and notifies the listeners
 * when a certain of threshold of memory is used after GC (collection usage).
 */
public class HeapMemoryMonitor {
    private static final Logger LOG = LogManager.getLogger(HeapMemoryMonitor.class.getName());
